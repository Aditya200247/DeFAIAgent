...
import { FlareDataConnector } from "../fdc"
...
export class Network extends NetworkBased {
    ...
    constructor(constants: Constants) {
        ...
        this._fdc = new FlareDataConnector(this._core)
    }
    ...
    protected _fdc: FlareDataConnector
    ...
    /**
     * Returns the Flare Data Connector instance.
     */
    get fdc(): FlareDataConnector {
        return this._fdc
    }
